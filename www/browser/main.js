...
} from "./chunk-Z4VH2DQQ.js";
import "./chunk-3GCQGGTR.js";
import {
  Menu,
  MenuoriginalComponent
} from "./chunk-KDPGP7UT.js";
import "./chunk-QVSGVATM.js";
import {
  ToastController,
  provideIonicAngular
...
import {
  NewPostComponent
} from "./chunk-2ROWNNIM.js";
import "./chunk-LMVSORKF.js";
import "./chunk-3XK6PZ6Q.js";
import {
  add,
  addCircle,
  addIcons,
...
var routes = [
  ...
  {
    path: "registro",
    loadComponent: () => import("./registro.component-AK7O5G7F.js").then((m) => m.RegistroComponent)
  },
  {
    path: "login",
    loadComponent: () => import("./login.component-FYEJOOSA.js").then((m) => m.LoginComponent)
  },
  {
    path: "posts",
    loadComponent: () => import("./posts.component-JOAV235E.js").then((m) => m.PostsComponent)
  },
  {
    path: "notification",
    loadComponent: () => import("./notification.component-P4YIGQBX.js").then((m) => m.NotificationComponent)
  },
  {
    path: "profile/:id",
    loadComponent: () => import("./profile.component-TK66JIV7.js").then((m) => m.ProfileComponent)
  },
  {
    path: "profile",
    loadComponent: () => import("./profile.component-TK66JIV7.js").then((m) => m.ProfileComponent)
  ...
  {
    path: "menuoriginal",
    loadComponent: () => import("./menuoriginal.component-FN6EIVEI.js").then((m) => m.MenuoriginalComponent),
    canActivate: [AuthGuard]
  },
  {
    path: "admin",
    loadComponent: () => import("./admin.component-WSLQBYQH.js").then((m) => m.AdminComponent)
  },
  {
    path: "search",
  ...
  {
    path: "settings",
    loadComponent: () => import("./settings.component-MD5LWUZX.js").then((m) => m.SettingsComponent)
  },
  {
    path: "health",
    loadComponent: () => import("./health.component-I7UYGZVI.js").then((m) => m.HealthComponent)
  },
  {
    path: "recu",
    loadComponent: () => import("./recuperacion-previa.component-EIU6ZM6J.js").then((m) => m.RecuperacionPreviaComponent)
  },
  {
    path: "post-save",
    loadComponent: () => import("./post-save.component-GIM4HQPG.js").then((m) => m.PostSaveComponent)
  },
  {
    path: "post-details/:id",
    loadComponent: () => import("./post-details.component-GY5UZJJB.js").then((m) => m.PostDetailsComponent),
    canActivate: [AuthGuard]
  },
  {
    path: "posts-user/:id",
    loadComponent: () => import("./posts-user.component-TTEOQU3S.js").then((m) => m.PostsUserComponent)
  },
  {
    path: "chat/:groupId",
    loadComponent: () => import("./rafaparaelchat.component-HYE56FTD.js").then((m) => m.RafaparaelchatComponent)
  },
  {
    path: "mensajes",
    loadComponent: () => import("./mensajes.component-6MEH7IEY.js").then((m) => m.MensajesComponent)
  },
  {
    path: "suggestion",
    loadComponent: () => import("./suggestions.component-K7FPJHYW.js").then((m) => m.SuggestionsComponent),
    canActivate: [AuthGuard]
  }
];
...
var _WebsocketServiceNotification = class _WebsocketServiceNotification {
  ...
  connect(roomId) {
    const webSocketUrl = `https://powerzone-back-elk6.onrender.com/ws-native`;
