...
var _PostService = class _PostService {
  constructor(http) {
    this.http = http;
    this.apiUrl = "https://powerzone-back-elk6.onrender.com/post";
  }
  getHeaders(token) {
  ...
  getPostById(token, postId) {
    return this.http.get(`https://powerzone-back-elk6.onrender.com/post/${postId}`, {
  ...
  isNewUser(token) {
    ...
    return this.http.post("https://powerzone-back-elk6.onrender.com/auth/isTutorialComplete", {}, { headers });
  }
  changeUserStatus(token) {
    const headers = new HttpHeaders({ Authorization: token });
    return this.http.post("https://powerzone-back-elk6.onrender.com/auth/tutorialComplete", {}, { headers });
  }
};
...
//# sourceMappingURL=chunk-3XK6PZ6Q.js.map
