...
var _RecuperacionServiceService = class _RecuperacionServiceService {
  ...
  sendEmail(email) {
    return this.http.post(`https://powerzone-back-elk6.onrender.com/api/auth/forgot-password?email=${email}`, null);
  }
  sendNewPassword(code, newPassword) {
    return this.http.post(`https://powerzone-back-elk6.onrender.com/api/auth/reset-password?code=${code}&newPassword=${newPassword}`, null);
  }
};
...
//# sourceMappingURL=recuperacion-previa.component-EIU6ZM6J.js.map
