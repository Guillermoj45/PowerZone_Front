...
var _WebsocketService = class _WebsocketService {
  ...
  getGroupDetails(groupId) {
    const url = `https://powerzone-back-elk6.onrender.com/messages/grupos/${groupId}`;
  ...
  getUserGroups() {
    const url = `https://powerzone-back-elk6.onrender.com/messages/info`;
    const token = sessionStorage.getItem("token");
  ...
  getFollowingProfiles() {
    const url = `https://powerzone-back-elk6.onrender.com/profile/following`;
    const token = sessionStorage.getItem("token");
    if (!token) {
  ...
  createGroup(groupName, file) {
    const url = "https://powerzone-back-elk6.onrender.com/messages/create";
    const token = sessionStorage.getItem("token");
  ...
  addUsersToGroup(groupId, userIds) {
    const url = `https://powerzone-back-elk6.onrender.com/messages/addUsersToGroup`;
    const token = sessionStorage.getItem("token");
  ...
  getMessagesByGroup(groupId) {
    const url = `https://powerzone-back-elk6.onrender.com/messages/group/${groupId}`;
    const token = sessionStorage.getItem("token");
    const headers = { Authorization: `Bearer ${token}` };
    return this.http.get(url, { headers });
  }
  ...
  getUltimosMensajesPorGrupo() {
    const url = `https://powerzone-back-elk6.onrender.com/messages/grupos/ultimos-mensajes`;
    const token = sessionStorage.getItem("token");
    const headers = { Authorization: `Bearer ${token}` };
    return this.http.get(url, { headers });
  }
...
//# sourceMappingURL=chunk-XVWDC2ZH.js.map
