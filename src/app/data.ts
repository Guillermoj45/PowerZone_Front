...
export const steps = [
    {
        ...
        attachTo: { element: '.posts-list', on: 'bottom' as PopperPlacement },
        buttons: [
            {
                text: 'Siguiente',
    ...
    },
    {
        ...
        attachTo: { element: '.post-item', on: 'right' as PopperPlacement },
        buttons: [
            {
                text: 'Siguiente',
                action: function(this: any) { this.next(); }
    ...
    },
    {
        ...
        attachTo: { element: '.like-button', on: 'left' as PopperPlacement },
        buttons: [
            {
                text: 'Siguiente',
                action: function(this: any) { this.next(); }
    ...
    },
    {
        ...
        attachTo: { element: '.save-button', on: 'left' as PopperPlacement },
        buttons: [
            {
                text: 'Siguiente',
                action: function(this: any) { this.next(); }
    ...
    },
    {
        ...
        attachTo: { element: '.sidebar', on: 'left' as PopperPlacement },
        buttons: [
            {
                text: 'Siguiente',
                action: function(this: any) { this.next(); }
    ...
    },
    {
        ...
        attachTo: { element: '.search-bar', on: 'top' as PopperPlacement },
        buttons: [
            {
                text: 'Siguiente',
                action: function(this: any) { this.next(); }
    ...
    },
    {
        ...
        attachTo: { element: '.publish-button', on: 'left' as PopperPlacement },
        buttons: [
            {
                text: 'Siguiente',
                action: function(this: any) { this.next(); }
    ...
    },
    {
        ...
        attachTo: { element: '.chatbot', on: 'left' as PopperPlacement },
        buttons: [
            {
                text: 'Siguiente',
                action: function(this: any) { this.next(); }
    ...
    },
    {
        ...
        attachTo: { element: '.notifications', on: 'left' as PopperPlacement },
        buttons: [
            {
                text: 'Siguiente',
                action: function(this: any) { this.next(); }
    ...
    },
    {
        ...
        attachTo: { element: '.profile', on: 'left' as PopperPlacement },
        buttons: [
            {
                text: 'Siguiente',
                action: function(this: any) { this.next(); }
    ...
    },
    {
        ...
        attachTo: { element: '.settings', on: 'left' as PopperPlacement },
        buttons: [
            {
                text: 'Siguiente',
                action: function(this: any) { this.next(); }
    ...
    },
    {
        ...
        attachTo: { element: '.suggestions', on: 'left' as PopperPlacement },
        buttons: [
            {
                text: 'Finalizar',
